      ...
      <div className="shell">
        <div className="about-grid reveal">
          ...
          <div className="about-text">
            ...
            <p> Sabemos que no te gusta pagar facturas de electricidad cada vez más altas. Que quieres aprovechar mejor tu dinero, tener más control sobre lo que consumes y dejar de depender por completo de una energía que no puedes controlar.<br/>
              
              Por eso existimos.<br/>
              
              En ENOVA diseñamos e instalamos sistemas solares a la medida de hogares y empresas que quieren hacer las cosas de una forma más inteligente: generar parte de su propia energía, reducir sus costos y ganar autonomía sin complicarse la vida.<br/>
              
              Nos encargamos de todo el camino, desde el diseño y la selección de equipos hasta la instalación, puesta en marcha y acompañamiento de tu sistema.<br/>
